...
const BASE_URL = "http://192.168.43.175:8080/api/presensi";
...
export default function App() {
  ...
  // ---- GPS: minta izin & ambil lokasi awal ----
  useEffect(() => {
    (async () => {
  ...
  // ---- Tarik marker ke posisi pengguna ----
  ...
  // ---- Simpan koordinat marker yang dipilih ----
